...
export const tiltOptions: TiltOptions = {
  reverse: false, // reverse the tilt direction
  max: 3, // max tilt rotation (degrees)
  startX: 0, // the starting tilt on the X axis, in degrees.
  startY: 0, // the starting tilt on the Y axis, in degrees.
  perspective: 975, // Transform perspective, the lower the more extreme the tilt gets.
  ...
  'mouse-event-element': null as any, // css-selector or link to an HTML-element that will be listening to mouse events
