...
export const Arrows2 = ({ mode, onClick, className }: Props) => {
  // wrapperClassName;
  let wrapperClassName = 'group p-8 cursor-pointer z-30 absolute bg-darker/70 hover:bg-dark/90 active:bg-dark ease-in-out duration-[800ms] w-full h-full top-0 flex items-center justify-center__ align-middle ';
